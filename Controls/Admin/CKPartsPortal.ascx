<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="CKPartsPortal.ascx.vb" Inherits="Pigeon.CKPartsPortal1" %>
    <link href="//netdna.bootstrapcdn.com/bootstrap/3.0.0/css/bootstrap-glyphicons.css" rel="stylesheet">

    <script type="text/javascript">

        $(document).ready(function () {
            var cboCompany = "<%=cboCompany.ClientID%>";
            $('#' + cboCompany).change(function () {
                var url = "/OrderWebService.asmx/getEmailsByCustomerNo";
                var Data = { "CustomerNo": $(this).val(), "Client": user.Client };
    ...
    <script id="oemResultsTemplate" type="text/x-jquery-tmpl">
        <div class="total-container">
            ...
            <p style="font-weight: bold;" class="part-stock">
               {{if Stock == "Yes"}} 
                In Stock
...
<script id="aftermarketResultsTemplate" type="text/x-jquery-tmpl">
        ...
        <div style="margin-bottom: 4em;" class="container-fluid">
            ...
            <div class="row-fluid">
                <table>
                    <tr>
                        <td>               
                             <div class="span6">
                    <div class="title-contain" id="Div1">
                        <h5 class="help-inline">Select Customer:</h5>
                                 <asp:SqlDataSource ID="dsCustomers" runat="server" 
                                     ConnectionString="<%$ ConnectionStrings:CKConnectionString %>" 
                SelectCommand="SELECT ChargeOEMEOC,CustomerNo, Company FROM [tblCompany] where active=1 and company is not null and type='Customer' and customerno <>'0' and customerno is not null union select 'false','0', ' Please Select' oRDER BY [Company]">
            </asp:SqlDataSource>
                        <asp:DropDownList TabIndex="1" style="margin: 1em 0;" ID="cboCompany" CssClass="cboCompany" runat="server" DataMember="DefaultView" 
                            DataSourceID="dsCustomers" DataTextField="Company"  DataValueField="CustomerNo" AppendDataBoundItems="True" >
                        </asp:DropDownList>
                     </div>
                </div>
                         </td>
                  ...
                  <h5 class="help-inline">Select Customer Email:</h5>
                                <input type="text" class="cboCompany" placeholder="Customer Name" style="display:none;" id="txtAdjusterEmail" />
                              <select class="cboCompany" style="display:inline-block;" id="DDLEmail">
                              </select>
                                <i class="glypicon glyphicon-plus" style="float: right;font-size: 30px;" onclick="HideShowEmailDDL()"></i>
                        </div>
                                </div> 
                        </td>
                        <td>            <div class="span6">
                <div class="title-contain" id="select-make-contain">
                    <h5 class="help-inline">Select make:</h5>

                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:CKConnectionString %>" 
                        SelectCommand="SELECT * FROM [tblMake] where makeid <> 33  ORDER BY [Make]">
                    </asp:SqlDataSource>
                    <asp:DropDownList TabIndex="2" style="margin: 1em 0;" ID="cbomake2" CssClass="cbomake" runat="server" DataMember="DefaultView" 
            ...
            <div class="row-fluid">
                <div class="span12" id="stock-info">
	            ...
	            <div class="row-fluid">
                    ...
                    <div style="display:none;" id="checkout" class="span8 last">
                        ...
                        <ul style="display:none;" id="error_contain"></ul>
                            <table>
                                <tr>
                                    <td>  <label>Year<span class="small">2-digit Year</span></label></td>
                                    <td><input class="required" type="text" name="year" id="year" /></td>
                                    <td><label>Make<span class="small">Vehicle Make</span></label></td>
                                    <td> <input disabled="disabled" type="text" name="make" id="make" /></td>
                                </tr>
                                <tr>
                                    <td> <label>Model<span class="small">Vehicle Model</span></label></td>
                                    <td> <input type="text" name="model" id="model" /></td>
                                    <td><label>VIN<span class="small"></span></label></td>
                                    <td> <input type="text" name="vin" id="vin" /></td>
                                </tr>
                                <tr>
                                    <td> <label>Mileage<span class="small">Vehicle Mileage</span></label></td>
                                    <td>   <input type="text" name="mileage" id="mileage" /></td>
                                    <td>  <label>Trans<span class="small">Tranmission Type</span></label></td>
                                    <td> <select id="trans">
                            ...
                            <option value="Manual">Manual</option>
                                     ...
                                     <tr>
                                    <td><label>Contract No<span class="small"></span></label></td>
                                    <td> <input type="text" name="contractno" id="contractno" /></td>
                                    <td><label>Auth No<span class="small"></span></label></td>
                                    <td> <input type="text" name="authno" id="authno" /></td>
                                </tr>
                                     <tr>
                                    <td> <label>Owner<span class="small">Vehicle Owner</span></label></td>
                                    <td><input type="text" name="owner" id="owner" /></td>
                                    <td> <label>Shop<span class="small">Shop Name</span></label></td>
                                    <td><input type="text" name="shop" id="shop" /></td>
                                </tr>
                                     <tr>
                                    <td><label>Address<span class="small">Shop Address</span></label></td>
                                    <td> <input type="text" name="address" id="address" /></td>
                                    <td> <label>City<span class="small">Shop City</span></label></td>
                                    <td> <input type="text" name="city" id="city" /></td>
                                </tr>
                                   <tr>
                                    <td>  <label>State<span class="small">Shop State</span></label></td>
                            ...
                            <option value="YT">Yukon</option>
                                    ...
                                    <td>
                        <label>Zip<span class="small">Shop Zip</span></label></td>
                                    <td>  <input type="text" name="zip" id="zip" /></td>
                                </tr>
                                           <tr>
                                    <td> <label>Contact<span class="small">Shop Contact</span></label></td>
                                    <td><input type="text" name="contact" id="contact" /></td>
                                    <td><label>Phone<span class="small">Shop Phone</span></label></td>

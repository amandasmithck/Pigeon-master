<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Pages/Pigeon.Master" CodeBehind="PaymentsMarked.aspx.vb" Inherits="Pigeon.PaymentsMarked" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function GetData() {
            ...
            $.ajax({
                type: "POST",
                url: "../ReportsWebService.asmx/GetPaymentsMarked",
                data: jsonData,

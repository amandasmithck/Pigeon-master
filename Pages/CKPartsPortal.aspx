<%@ Page Title="Parts Portal" Language="vb" AutoEventWireup="false" MasterPageFile="~/Pages/Pigeon.Master" CodeBehind="CKPartsPortal.aspx.vb" Inherits="Pigeon.CKPartsPortal3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" src="../Scripts/partsportal-1.3.js"></script>

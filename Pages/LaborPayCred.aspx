<%@ Page Language="vb" AutoEventWireup="false"  MasterPageFile="~/Pages/Pigeon.Master" CodeBehind="LaborPayCred.aspx.vb" Inherits="Pigeon.LaborPayCred" %>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    

     <script id="printTemplate" type="text/html">
        <tr>
           <td>${accounting.formatMoney(LaborPayouts)}</td> 
           <td>${accounting.formatMoney(LaborCredits)}</td>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function GetData() {
            ...
            $.ajax({
                type: "POST",
                url: "../ReportsWebService.asmx/GetLaborPayCred",
                data: jsonData,

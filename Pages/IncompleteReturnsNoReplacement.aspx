<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Pages/Pigeon.Master" CodeBehind="IncompleteReturnsNoReplacement.aspx.vb" Inherits="Pigeon.IncompleteReturnsNoReplacement" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('document').ready(function () {
            ...
            var urlMethod = "../OrderWebService.asmx/GetIncompleteReturnsNoReplacement";

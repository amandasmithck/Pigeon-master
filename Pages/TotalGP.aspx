<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Pages/Pigeon.Master" CodeBehind="TotalGP.aspx.vb" Inherits="Pigeon.TotalGP" ValidateRequest="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function GetData() {
            ...
            $.ajax({
                type: "POST",
                url: "../ReportsWebService.asmx/GetTotalGP",
                data: jsonData,

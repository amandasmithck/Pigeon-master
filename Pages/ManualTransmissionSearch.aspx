<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Pages/Pigeon.Master" CodeBehind="ManualTransmissionSearch.aspx.vb" Inherits="Pigeon.ManualTransmissionSearch" %>
...
<script src="/Scripts/Quotes-v1.6-.js"></script>
    <style type="text/css">
	    #details tbody tr:hover {background: #B0BED9; cursor: pointer;}
	    #details tbody tr.selected {background-color: #D8F0C0;}
    </style>
        ...
        <div class="row-fluid">
            ...
            <div class="span9  search-results">
                <div id="catalog" style="display:none">
                    <table id="details">
                        <thead>
                            <tr><td style="display:none;">Local Stock</td><th>Part #</th><%--<th>Core Value</th>--%>
    ...
    <script id="pricingTemplate" type="text/html">
        ...
        <div class="popover-content" style="padding:9px 0px">
            <div class="container-fluid">
                <div class="row-fluid">
                    <div class="span6">
                        <div id="Div1" class="map"></div>
                    </div>
                    <div class="span6">
                        <table class="table table-pricing table-bordered">
                          {{each tiers}}
                                {{if TierID >=3}}
                              <tr class="info">
  ...
  <div class="accordion-group">
    ...
    <table class="table table-hover table-bordered table-pricing">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="field">${Label}</td>
                            <td class="price"><a class='checkout-button'>${accounting.formatMoney(Price)}</a></td>                                
                        </tr>
                        {{/each}}
                    </tbody>
                </table>
    ...
    <script type="text/javascript">
        ...
        $('document').ready(function () {
            ...
            var searchOptions = {
                ...
                , asmxLocation: '../ManualTransmissionWebService.asmx/'
            ...
            $('#btnVinSearch').click(function() {
                $('.search-results').append('<div class="loader"><img src="/images/ajax-loader-blue.gif" /></div>');
                var urlMethod = "../ManualTransmissionWebService.asmx/GetDataByVIN";
            ...
            $('#details tbody tr').live('click', function () {
                ...
                var urlMethod = "../ManualTransmissionWebService.asmx/GetPrice";
                ...
                SendAjax(urlMethod, jsonData, function (msg) {
                    ...
                    if (user.Client == "CK" && (user.Tier == "2")) {
                        $('.pigeon-pricing-header-accordion').each(function () {
                            $(this).show();
                            var pigeonpricing = new PigeonPricing($(this).find('.pigeon-pricing').attr('rel'),10);

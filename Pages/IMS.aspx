<%@ Page Title="IMS" Language="vb" AutoEventWireup="false" MasterPageFile="~/Pages/Pigeon.Master"
    CodeBehind="IMS.aspx.vb" Inherits="Pigeon.IMS2" %>
...
<asp:Content ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function GetStock() {
            ...
            var json = { 'client': user.Client, 'type': 1 };
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="main-content  container-fluid">
        <div class="row-fluid">
            <div class="span12"><h3>Transmission IMS</h3></div>
        </div>
        <div class="row-fluid">
   ...
   <div class="unsalable-message" title="Confirmation">
        <p>Are you sure you wish to mark this part as unsalable?</p>
       <span id="unsalable-sn"></span>
       <span id="unsalable-index" style="display:none"></span>
    </div>

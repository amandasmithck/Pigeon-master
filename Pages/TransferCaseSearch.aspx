<%@ Page Title="Transfer Case Search" Language="vb" AutoEventWireup="false" MasterPageFile="~/Pages/Pigeon.Master" CodeBehind="TransferCaseSearch.aspx.vb" Inherits="Pigeon.TransferCaseSearch2" %>
        ...
        <div class="row-fluid">
            ...
            <div class="span9 search-results">
                <div id="catalog" style="display:none">
                    <table id="details">
                        <thead>
                            <tr><td style="display:none;">Local Stock</td><th>Part #</th><%--<th>Core Value</th>--%><th style="text-align:left">Description</th></tr>
                        </thead>
                        <tbody></tbody>
                    </table>
                </div>
    ...
    <script type="text/javascript">
        ...
        $('document').ready(function () {
            ...
            var searchOptions = {
                ...
                , asmxLocation: '../TransferCaseWebService.asmx/'
            ...
            $('#btnVinSearch').click(function() {
                $('.search-results').append('<div class="loader"><img src="/images/ajax-loader-blue.gif" /></div>');
                var urlMethod = "../TransferCaseWebService.asmx/GetDataByVIN";
                ...
                SendAjax(urlMethod, jsonData, function (msg) {
                    ...
                    if (user.Client == "CK" && (user.Tier == "2")) {
                        $('.pigeon-pricing-header-accordion').each(function () {
                            $(this).show();
                            var pigeonpricing = new PigeonPricing($(this).find('.pigeon-pricing').attr('rel'),4);
        ...
        function RequestQuote(partNumber) {
            ...
            var url = "../TransferCaseWebService.asmx/InsertNewQuote";
            var json = {

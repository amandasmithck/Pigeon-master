<%@ Page Language="vb" AutoEventWireup="false"  MasterPageFile="~/Pages/Pigeon.Master" CodeBehind="EngineIMS.aspx.vb" Inherits="Pigeon.EngineIMS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function GetStock() {
            ...
            var json = { 'client': user.Client, 'type': 2 };
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="main-content  container-fluid">
        <div class="row-fluid">
            <div class="span12"><h3>Engine IMS</h3></div>
        </div>
        <div class="row-fluid">
